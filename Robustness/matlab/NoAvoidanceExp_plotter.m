...
% ylim([-2e0,ub])
% xlabel('Wealth bins','fontsize',myfs)
% ylabel('CEV (percent)','fontsize',myfs)
% if do_save==1; print(fullfile(FigDir,'exp5_cev_qo'),'-dpng'); end
% if do_save==1; print(fullfile(FigDir,'exp5_cev_qo'),'-depsc'); end
...
legend('Total revenue (excl. soc. sec.)','Soc. sec. revenue','Soc. sec. rate', ...
    'fontsize',myfs,'location','best','numColumns',1)
