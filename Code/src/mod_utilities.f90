module mod_utilities
    ...
    !  20220503   A. Di Nola       Common interface for all writedim, readdim
    !  20220620   H. Wang          Added read4dim
    ...
    interface readdim
        ...
        module procedure read4dim_i
        module procedure read4dim_r
        module procedure read5dim_i
        module procedure read5dim_r
        module procedure read6dim_i
        module procedure read6dim_r
    end interface
  ...
  !***********************************************************
    ...
    subroutine read4dim_i(x,file_name)
    ...
    open(newunit=unitno, file=file_name, status='old', iostat=ierr)
    if (ierr/=0) then
        write(*,*) "Error in read4dim: cannot open file"
		pause
		stop 
    endif
    ...
    end subroutine read4dim_i
    !=======================================================================!
    
    subroutine read4dim_r(x,file_name)
    ...
    end subroutine read4dim_r
    !=======================================================================!
    
    subroutine read5dim_i(x,file_name)
    ...
    open(newunit=unitno, file=file_name, status='old', iostat=ierr)
    if (ierr/=0) then
        write(*,*) "Error in read5dim: cannot open file"
		pause
		stop 
    endif
    ...
    end subroutine read5dim_i
    !=======================================================================!
    
    subroutine read5dim_r(x,file_name)
    ...
    end subroutine read5dim_r
    !=======================================================================!
    
    subroutine read6dim_i(x,file_name)
    ...
    open(newunit=unitno, file=file_name, status='old', iostat=ierr)
    if (ierr/=0) then
        write(*,*) "Error in read6dim: cannot open file"
		pause
		stop 
    endif
    ...
    do i4 = 1,size(x,dim=4)
		do i3 = 1,size(x,dim=3)
			do i2 = 1,size(x,dim=2)
				do i1 = 1,size(x,dim=1)
					read(unitno,*) x(i1,i2,i3,i4,i5,i6)
				enddo
			enddo
		enddo
    enddo
    ...
    end subroutine read6dim_i
     !=======================================================================!
    
    subroutine read6dim_r(x,file_name)
